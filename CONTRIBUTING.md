...
Thank you for your interest in contributing to Recall! This document provides guidelines and instructions for contributing to this project.
...
2. Clone your fork:
   ...
   ```
3. Add the repositories as remotes:
   ```bash
