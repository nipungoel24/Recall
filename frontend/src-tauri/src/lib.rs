...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Calendar range commands (§3.1)
            api::calendar::api_get_meetings_by_range,
            api::calendar::api_get_dates_with_meetings,
            // Daily summary commands (§5.2)
            summary::daily_commands::api_get_daily_summary,
            summary::daily_commands::api_cancel_daily_summary,
            summary::daily_commands::api_generate_daily_summary,
            // Template commands (§4.2)
            ...
            contexts::commands::api_create_context_thread,
            contexts::commands::api_update_context_thread,
            contexts::commands::api_delete_context_thread,
            contexts::commands::api_add_meeting_to_context,
            contexts::commands::api_remove_meeting_from_context,
            contexts::commands::api_get_context_meetings,
            contexts::commands::api_get_context_memory,
            contexts::commands::api_add_context_memory_item,
