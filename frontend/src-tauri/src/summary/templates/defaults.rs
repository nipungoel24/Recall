...
/// Daily Brief template for a synthesized end-of-day brief across meetings
pub const DAILY_BRIEF: &str = include_str!("../../../templates/daily_brief.json");
...
pub fn list_builtin_template_ids() -> Vec<&'static str> {
    vec!["daily_standup", "standard_meeting", "daily_brief"]
}
