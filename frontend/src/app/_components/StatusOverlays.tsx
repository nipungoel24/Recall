    ...
    <div className="fixed bottom-4 left-0 right-0 z-10">
      ...
      >
        <div className="w-2/3 max-w-[750px] flex justify-center">
          <div className="flex items-center space-x-2 rounded-lg border border-border bg-background px-4 py-2">
            <div className="h-4 w-4 animate-spin rounded-full border-2 border-border border-t-foreground motion-reduce:animate-none" />
