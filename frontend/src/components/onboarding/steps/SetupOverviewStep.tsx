...
export function SetupOverviewStep() {
  ...
  return (
    <OnboardingContainer
      ...
      description="Recall requires that you download the Transcription & Summarization AI models for the software to work."
      step={2}
      ...
      <div className="flex flex-col items-center space-y-10">
        ...
        <div className="w-full max-w-xs space-y-4">
          ...
          <div className="text-center">
            <a
              href="https://github.com/nipungoel24/Recall"
              target="_blank"
